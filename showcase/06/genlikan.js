...
Robot3.prototype.show = function(scene) {
...
Robot3.prototype.onAnimate = function() {
...
Robot3.prototype.raise_left_arm = function() {
	this.movement = 'raise left arm';
	};

Robot3.prototype.lower_left_arm = function() {
	this.movement = 'lower left arm';
	};

Robot3.prototype.right_kick = function() {
	this.movement = 'right kick';
	};

Robot3.prototype.left_kick = function() {
	this.movement = 'left kick';
	};

Robot3.prototype.dance = function() {
	this.movement = 'time2dance';
	console.log("It's Party Time!");
	};

Robot3.prototype.freeze = function() {
	this.movement = 'null';
